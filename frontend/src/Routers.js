...
import AddCourseStructure from './components/schooladmin/CourseStructure/AddCourseStructure';
import ManageCourseStructure from './components/schooladmin/CourseStructure/ManageCourseStructure';
      ...
      <Suspense fallback={<Spinner/>}>
        <Switch>
          ...
          <Route path="/admin/submitstudentfee" component={SubmitStudentFee} />
					...
					<Route path="/admin/addcoursestructure" component={AddCourseStructure} />
					<Route path="/admin/coursestructure" component={ManageCourseStructure} />
